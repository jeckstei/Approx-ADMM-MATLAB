function [ x, lambda, conv_log ] = rand_start_admm_exact_lasso( A, b, c, epsilon )
    ...
    while outer_iter < max_out_iter
        ...
        while inner_iter < max_inner_iter            
            ...
            if norm(r) <= epsilon / 10 
                % record number of inner iterations between each outer
                % iteration
        ...
        conv_log.obj_val(outer_iter) = funeval_lasso(A,b,x,z,nu);
