function [ x, p, conv_log ] = admm_LBFGS_test( A, b, c, epsilon, m )
...
%         residual, inner iteration number at each outer iteration.
    ...
    while outer_iter < max_out_iter
        ...
        [objVal,fVal,gradf,grad] = funcval_logreg(x,z,p,A,b,c,nu);
        ...
        while inner_iter < max_inner_iter
            ...
            xOld = x;
            gradOld = grad;
            [s,x,fVal,gradf,grad,~] = linesearch(x,z,p,fVal,grad,d,wolfeCondC1,wolfeCondC2,A,b,c,nu);
